...
public class UserTest {
	...
	public void shouldCalculateCouponTotalForOneOrTwoPersonFamily() {
		User user = new User("firstName", "lastName", 1, 0, false, date, "00000", "1234 Main St");
	...
	public void shouldCalculateCouponTotalForThreePersonFamily() {
		User user = new User("firstName", "lastName", 3, 0, false, date, "00000", "1234 Main St");
		int couponTotal = user.calculateCouponLimit();
	...
	public void shouldCalculateMeatTotalForSixOrMorePersonFamily() {
		User user = new User("firstName", "lastName", 6, 0, false, date, "00000", "1234 Main St");
		int meatTotal = user.calculateMeatLimit();
	...
	public void shouldTakeZipCode12345() {
		String zip = "12345";
		User underTest = new User("firstName", "lastName", 1, 1, true, date, zip, "1234 Main St");
