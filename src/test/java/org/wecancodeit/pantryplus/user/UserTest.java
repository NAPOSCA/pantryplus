...
public class UserTest {
	...
	public void shouldCalculateCouponTotalForOneOrTwoPersonFamily() {
		User user = new User("firstName", "lastName", 1, 0, false, date, "00000", "1234 Main St", "January 1st, 1969", "777-777-7777", "happy@nowhere");
	...
	public void shouldCalculateCouponTotalForThreePersonFamily() {
		User user = new User("firstName", "lastName", 3, 0, false, date, "00000", "1234 Main St", "January 1st, 1969", "777-777-7777", "happy@nowhere");
		int couponTotal = user.calculateCouponLimit();
	...
	public void shouldCalculateMeatTotalForSixOrMorePersonFamily() {
		User user = new User("firstName", "lastName", 6, 0, false, date, "00000", "1234 Main St", "January 1st, 1969", "777-777-7777", "happy@nowhere");
		int meatTotal = user.calculateMeatLimit();
	...
	public void shouldTakeZipCode12345() {
		String zip = "12345";
		User underTest = new User("firstName", "lastName", 1, 1, true, date, zip, "1234 Main St", "January 1st, 1969", "777-777-7777", "happy@nowhere");
	...
	public void shouldAddFamilySizeToModel() {
		int familySize = 4;
		User underTest = new User("firstName", "lastName", familySize, 0, true, date, "", "", "January 1st, 1969", "777-777-7777", "happy@nowhere");
	...
	public void shouldAddBirthdateToModel() {
		...
		User underTest = new User("firstName", "lastName", 0, 0, true, date, "", "", birthdate, "777-777-7777", "happy@nowhere");
	...
	public void shouldAddAddressToModel() {
		...
		User underTest = new User("firstName", "lastName", 0, 0, true, date, "", address, "January 1st, 1969", "777-777-7777", "happy@nowhere");
	...
	public void shouldAddSacToModel() {
		int sacs = 2;
		User underTest = new User("firstName", "lastName", 6, sacs, true, date, "", "", "January 1st, 1969", "777-777-7777", "happy@nowhere");
